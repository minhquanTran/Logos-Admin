...
public class StatsElasticFinal {
	...
	public static void main(String[] args) throws IOException {
		...
		//ajouter tous les utilisateurs (tous types confondus) : cr�ation de l'index users
...
//		}
		...
		// ajouter tous les historiques de connexions : cr�ation de l'index connex_historique
...
//		// ajouter le nbr de loves total, le nbr moyen de visite par jour et la dur�e moyenne de connexion : cr�ation de l'index nbr_love_connex
		lc.addCalculLoveConnex(listeConnex);
//		lc.getDureeConnexMoyen();
